...
public class Custom3DView extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int measureWidth = MeasureSpec.getSize(widthMeasureSpec);   //获得ViewGroup宽度
        int measureHeight = MeasureSpec.getSize(heightMeasureSpec);  //获得ViewGroup长度
        setMeasuredDimension(measureWidth,measureHeight);

        MarginLayoutParams params = (MarginLayoutParams) this.getLayoutParams();    //获得margin参数
        int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(    //测量子控件
        ...
        measureChildren(childWidthMeasureSpec,childHeightMeasureSpec);  //设置子控件
